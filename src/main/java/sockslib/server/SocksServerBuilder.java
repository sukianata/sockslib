 ...
 * @since JDK1.7
 */
public class SocksServerBuilder {//用来构建代理服务器
  ...
  private SessionManager sessionManager = new BasicSessionManager();//session管理器
  private SSLConfiguration sslConfiguration;//SSL配置 ，即安全套接层协议
